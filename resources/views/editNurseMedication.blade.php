@extends('layouts.NurseLayout', ['title' => 'Edit Medication'])

@section('content')
<h3>Edit Medication</h3>
<a href="{{ route('nurseDoctorOrdersView', $order_medication->doctor_order_id) }}" style="background-color:#1f66d1;" class="btn btn-light btn-sm text-light ms-2">← Go back</a>
<div class="card p-1 m-4 ps-3 mx-auto w-50">
      <form method="POST" action="{{ route('updateNurseMedication') }}">
                ...
                <div class="col-4 p-2 mb-3 d-inline-block">
                ...
                <div class="col-4 p-2 me-5 mb-3 d-inline-block">
