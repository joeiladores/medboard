...
<div class="row">
    <div class="col-lg-10">
        <div class="card shadow" id="DashboardCard">
            <h4 id="DashboardText" style="position: absolute; color:#1353c9;">Good Day, Nurse
            ...
            <div class="col-lg-12">
                <div class="card rounded shadow mt-2 p-2" id="tableSize">
                    <table class="table" id="nursesDashboardTable">
                        <h5 class="pt-3 ms-2" style="color:#1353c9;">Patients under your station with Doctor's orders
                        </h5>
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Dr.
                                    {{ $patientsInStations->doctor_firstname . " " . $patientsInStations->doctor_lastname }}
                                </td>
                                <td>{{ $patientsInStations->firstname }} {{ $patientsInStations->lastname }}</td>
                                <td>{{ $patientsInStations->room }}</td>
                                <td>{{ date_format(new DateTime( $patientsInStations->created_at), "F j, Y g:i A") }}
                                </td>
                                <td>
                                    <a href="{{ route('nurseDoctorOrdersView', $patientsInStations->id) }}"
...
<link rel="stylesheet" type="text/css"
    href="https://cdn.datatables.net/v/bs5/dt-1.13.2/r-2.4.0/sc-2.0.7/datatables.min.css" />
<script type="text/javascript" src="https://cdn.datatables.net/v/bs5/dt-1.13.2/r-2.4.0/sc-2.0.7/datatables.min.js">
</script>
<script>
