...
<div class="card p-5 m-4">
      <form method="POST" action="{{ route('updateProgressNotes') }}">
                @csrf
            <div class="mb-3">
            <textarea class="form-control" id="progress_notes" name="progress_notes" rows="3" value="{{ $doctor_orders->progress_notes }}" required></textarea>
