    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="sidebar" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href=""
                    class="list-group-item list-group-item-action bg-transparent second-text fw-bold text-center">
                ...
                <a href="{{ route('profile') }}" class="list-group-item bg-transparent second-text fw-bold text-center">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent px-3">
                ...
                <div class="collapse navbar-collapse col-md-6" id="navbarSupportedContent">
                    ...
                    <div class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <span>   <p style="height:100%;" class="text-center">Dr. Warner Bros Smith <br>
                            Pediatrician <br> </p></span>
                        <img style="width: 64px; height: 64px;" class="rounded-circle img-thumbnail mb-1 img-fluid"
