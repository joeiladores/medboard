@extends('layouts.NurseLayout', ['title' => 'Edit Transfusion'])
...
<div class="card p-1 m-4 ps-3 mx-auto w-50">
      <form method="POST" action="{{ route('updateNurseTransfusion') }}">
                ...
                <div class="col-4 p-2 mb-3 d-inline-block">
                    ...
                    <input  class="form-control" type="date" id="date_started" name="date_started" value="{{ $order_transfusion->date_started }}"/>
                </div>
