            ...
            <div class = "container">
                ...
                <div class = "services-inner text-center grid">
                    <article class = "service-item">
                        ...
                        <p class = "text text-sm">Cardiac monitoring generally refers to continuous or intermittent monitoring of heart activity, generally by electrocardiography, with assessment of the patient's condition relative to their cardiac rhythm.</p>
                    </article>
                    ...
                    <article class = "service-item">
                        ...
                        <p class = "text text-sm">Medical treatment means the management and care of a patient to combat disease or disorder.</p>
                    </article>
                    ...
                    <article class = "service-item">
                        ...
                        <p class = "text text-sm">Services the MedBoard provides if you need urgent or emergency medical help.</p>
                    </article>
            ...
            <div class = "container">
                ...
                <div class = "package-service-inner grid">
                    ...
                    <div class = "package-service-item bg-white">
                        ...
                        <p class = "text text-sm">An so vulgar to on points wanted rapture ous resolving continued household</p>
                        <a href = "#" class = "btn btn-blue">Read More</a>
                    </div>
                </div>
            </div>
            ...
            <div class = "container grid">
                ...
                <div class = "contact-right text-white text-center bg-blue">
                    <div class = "contact-head">
                        ...
                        <p class = "text text-md">(+01)  256 567 550.
        ...
        <div class = "container">
            <div class = "footer-inner text-white py grid">
                <div class = "footer-item">
                    ...
                    <p class = "text text-md"> </p>Give their their without moving were stars called so divide female be moving night 
                        may fish him own male vreated great Give their their without moving were. 
                        Stars called so divide female moving night may fish him own male created great opportunity deal.</p>
                    <address>
                        Medic Clinic <br>
                ...
                <div class = "footer-item">
                    ...
                    <p class = "text text-md">Our Hospital is is very accomadating and you can make an appointment anytime</p>
                    <ul class = "appointment-info">
                        ...
                        <li>
                            ...
                            <span>medboard@gmail.com</span>
                        </li>
                        <li>
                            <i class = "fas fa-phone"></i>
                            <span>+001 321 7654(00)</span>
                        </li>
                    </ul>
                </div>
            </div>
